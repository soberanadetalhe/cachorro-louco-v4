...
# Versão 5.5 - Premium Home Correction | 11/04/2026 18:52
...
st.markdown("""
    <a href="https://wa.me/556291760052" style="position:fixed;width:60px;height:60px;bottom:40px;right:40px;background-color:#25d366;color:#FFF;border-radius:50px;text-align:center;z-index:1000;">
...
with tab1:
    ...
    with c3:
        st.image("https://i.ibb.co/WNB5pNMx/1775581194742.png", caption="Acabamento Premium")
...
with tab2:
    ...
    with col_e3:
        st.image("https://i.ibb.co/N6rcq709/1775580086384.png", caption="Extração Profunda em Carpetes e Tapetes")
    with col_e4:
...
with tab3:
    ...
    with st.form("agendamento"):
        # CORREÇÃO AQUI: Lista fechada corretamente e texto completo
        servico = st.selectbox("O que vamos transformar hoje?",
                               ["Lavagem (Carro)", 
                                "Proteção no Acabamento", 
                                "Higienização de Sofá (Veludo)", 
                                "Limpeza de Tapetes/Carpetes", 
                                "Combo Completo (Carro + Casa)"])
        ...
        if submit:
            ...
            st.markdown(f'''
                <a href="{link}" target="_blank" style="text-decoration:none;">
                    <button type="button" style="width:100%; height:50px; background-color:#25d366; color:white; border:none; border-radius:5px; font-weight:bold; cursor:pointer;">
